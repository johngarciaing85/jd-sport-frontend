          ...
          {!loading && clientes.length > 0 && (
            <div className="flex flex-col sm:flex-row gap-4 mb-6">
              ...
              <input
                ...
                className="sm:ml-auto w-full sm:w-72 bg-[#0d0d0d] border border-white/15 text-white text-sm px-4 py-1.5 placeholder:text-white/20 focus:outline-none focus:border-white/40 transition-colors tracking-wide"
              />
            </div>
          )}
